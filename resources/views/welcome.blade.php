...
<body class="bg-gray-900 text-white">
    ...
    <header class="bg-gray-800 text-white py-4 px-6 flex justify-between items-center">
        <h1 class="text-xl font-bold">AyalaGaming</h1>
    ...
    <main class="py-5">
        <div>
            <h2 class="text-2xl font-bold text-white text-center">BIENVENIDO A LAS JORNADAS GAMING DEL AYALA</h2>
            <p class="text-center text-gray-300 text-lg max-w-3xl mx-auto mt-2 mb-6">
                ¡Bienvenido a las Jornadas de Videojuegos del IES Ayala! Un espacio donde expertos, entusiastas y profesionales se reúnen para compartir conocimientos, descubrir nuevas tendencias y conectar con la comunidad. Explora nuestra lista de eventos y únete a una experiencia única de aprendizaje y networking.
            </p>
        </div>
                    ...
                    if (data.events && data.events.length > 0) {
                        ...
                        data.events.forEach(event => {
                            ...
                            let card = `<div class="bg-gray-800 border-4 border-gray-600 shadow-lg rounded-lg p-6 text-white">
                                ...
                                <p class="text-gray-300"><strong>Tipo:</strong> ${event.schedule?.type || 'No especificado'}</p>
                                ${day}
                                ${schedule}
